...
**Table structure:** | Table | Location | |-------|----------| | `<tableName>` | `s3a://<bucket>/<basePath>/latest.parquet/` |
...
**Table structure:** | Table | Location | |-------|----------| | `<tableName>_latest` | `s3a://<bucket>/<basePath>/latest.parquet/` | | `<tableName>_all` | `s3a://<bucket>/<basePath>/all.parquet/` |
...
**Table structure:** | Table | Location | |-------|----------| | `<tableName>` | `s3a://<bucket>/<basePath>/all.parquet/` |
