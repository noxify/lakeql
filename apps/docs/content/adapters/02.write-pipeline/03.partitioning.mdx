...
<InterfaceReference file="adapters/src/write-pipeline" name="ResolvedPartitioning" mode="declaration" />

<InlineReference file="adapters/src/write-pipeline" include={["PartitionMode", "PartitionSegment", "PartitionFieldError"]} />
