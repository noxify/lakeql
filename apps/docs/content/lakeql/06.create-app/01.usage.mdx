...
<Command variant="create">@lakeql/create-app</Command>
...
npx @lakeql/create-app my-api --package-manager=pnpm

# Skip install for CI
npx @lakeql/create-app my-api --no-install --quiet

# Short form
npx @lakeql/create-app my-api -pm=yarn
```
