---
title: Usage
description: How to use create-lakeql-app to scaffold a new project.
---

## Scaffolding a New Project

`create-lakeql-app` is LakeQL's project scaffolding tool. It downloads a starter template, configures dependencies, and sets up your project structure.
...
npx create-lakeql-app my-api --package-manager=pnpm

# Skip install for CI
npx create-lakeql-app my-api --no-install --quiet

# Short form
npx create-lakeql-app my-api -pm=yarn
```
