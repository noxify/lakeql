...
<InlineReference file="trino-client/src/types" include={["QueryProps"]} />
This is entirely transparent — you call `query()` and get the complete result
regardless of how many pages Trino needed internally.
