/**
 * Source: https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/json-schema
 */
...
export type JSONSchema4Array = JSONSchema4Type[]
...
// Workaround for infinite type recursion
// https://github.com/Microsoft/TypeScript/issues/3496#issuecomment-128553540
export type JSONSchema6Array = JSONSchema6Type[]
...
export interface JSONSchema6 {
   ...
   */
  properties?: Record<string, JSONSchema6Definition> | undefined
   ...
   */
  patternProperties?: Record<string, JSONSchema6Definition> | undefined
   ...
   */
  dependencies?: Record<string, JSONSchema6Definition | string[]> | undefined
   ...
   */
  definitions?: Record<string, JSONSchema6Definition> | undefined
...
// Workaround for infinite type recursion
// https://github.com/Microsoft/TypeScript/issues/3496#issuecomment-128553540
export type JSONSchema7Array = JSONSchema7Type[]
...
export interface JSONSchema7 {
  ...
  dependencies?: Record<string, JSONSchema7Definition | string[]> | undefined
