...
- harden schema/file generation for invalid field names by central normalization in schema-generator and fail-fast validation in file-generator AST builders
